  ...
  switch (action.type) {
    ...
    case 'CHECK_SUCCESS':
      return {
        ...
        allowMeritsEdit: action.payload.allowMeritsEdit,
        maxMerits: action.payload.maxMerits,
        merits: action.payload.merits,
        weightedScore: action.payload.weightedScore,
        examWeight: action.payload.examWeight,
